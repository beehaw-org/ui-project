...
const Sidebar = ({ className }: Props) => {
  return (
    <div className={classNames('font-serif font-bold', className)}>
      <div className='bg-primary-dark rounded-lg p-4 mb-4 w-full'>
      ...
      <div className='bg-primary-dark rounded-lg p-4 w-full'>
